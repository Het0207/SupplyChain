package com.supplychain.main.controller;
...
import com.supplychain.main.dao.AdminRepo;
import com.supplychain.main.dao.CartRepo;
import com.supplychain.main.dao.GroceryRepo;
import com.supplychain.main.dao.OrderRepo;
import com.supplychain.main.dao.UserRepo;
...
//			System.out.println(cart.get(i)[2]);
			...
			String photo = (String)gRepo.getPhoto(prodID);
			String name = (String)gRepo.getname(prodID);
			Date currDate = new Date();
			Orders order = new Orders(username,prodID,quantity,quantity*price,currDate,photo);
